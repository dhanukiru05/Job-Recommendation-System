...
# Load dataset:
jd_df=pd.read_csv(r'C:\projects\IR\Job-Recommendation-System-main\src\data\jd_structured_data.csv')

# Load the extracted resume skills:
file_path=r'C:\projects\IR\Job-Recommendation-System-main\utilities\resumes\CV.pdf'
skills=[]
